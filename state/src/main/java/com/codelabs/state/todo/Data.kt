...
enum class TodoIcon(val imageVector: ImageVector, @StringRes val contentDescription: Int) {
    Square(Icons.Default.Create, R.string.app_name),
    Done(Icons.Default.Done, R.string.app_name),
    Event(Icons.Default.Email, R.string.app_name),
    Privacy(Icons.Default.Person, R.string.app_name),
    Trash(Icons.Default.DateRange, R.string.app_name);
