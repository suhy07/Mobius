...
fun WriteCapsuleScreen(
    ...
    val return_mDate = remember { mutableStateOf("") }
    val isClick = rememberSaveable  { mutableStateOf(false) }
//    var selectList: MutableList<String> = mutableListOf("我自己")
    val selectType = rememberSaveable { mutableStateOf(writeCapsuleViewModel.selectList[0])}
    ...
    val mDatePickerDialog = DatePickerDialog(
        ...
        { _: DatePicker, mYear: Int, mMonth: Int, mDayOfMonth: Int ->
            ...
            return_mDate.value = "将于${mMonth+1}月${mDayOfMonth}日到达!"
            writeCapsuleViewModel.return_mDate.value = "信件将于${mMonth+1}月${mDayOfMonth}日到达"
        }, mYear, mMonth, mDay
    )
